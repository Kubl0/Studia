...
// Następnie wykorzystując zabieg przedstawiony w powyższych przykładach zmodyfikuj obiekt tak, 
// , aby po wyświetleniu obiektu dostać następujący output:
...
const movie2 = {
    ...
    country: 'Francja',
    year: 2011,
    actors: {Philippe: 'Francois Cluzet', Dris: 'Omar Sy', Yvonne: 'Anne Le Ny'}
}
